...
class RewriterApp(object):
    ...
    #DEFAULT_CSP = "default-src 'unsafe-eval' 'unsafe-inline' 'self' data: blob: mediastream: ws: wss:; script-src 'self' https://cdn.jsdelivr.net/npm/@floating-ui/dom@1.5.3/+esm 'unsafe-inline'; form-action 'self'"
